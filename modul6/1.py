...
gambarku = Image.open(r'D:\PRAK SMT 5\FUNGSIONAL\PRAK\FOTO\test.jpg')  # Ganti dengan path gambar Anda
...
direktoriFont = r'D:\PRAK SMT 5\FUNGSIONAL\PRAK\fonts\Begok v15_2015___free.ttf'  # Ganti dengan path font Anda
size = 50
font = ImageFont.truetype(direktoriFont, size)
text = "HALLO MASSSS, BISA NIH"
...
save_path = r'D:\PRAK SMT 5\FUNGSIONAL\PRAK\FOTO\hasil_edit.jpg'
